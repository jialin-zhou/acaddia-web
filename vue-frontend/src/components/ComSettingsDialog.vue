<template>
  <el-dialog v-model="dialogVisible" title="串口设置" width="500px" @close="onCancel">
    <el-form :model="form" label-width="80px" ref="formRef">
      <el-form-item label="COM口" prop="port">
        <el-select v-model="form.port" placeholder="请选择串口" :disabled="isConnected">
          <el-option v-for="item in availablePorts" :key="item" :label="item" :value="item"></el-option>
        </el-select>
        <el-button @click="fetchAvailablePorts" class="refresh-button" :disabled="isConnected">刷新</el-button>
      </el-form-item>
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="danger" @click="onDisconnect" :disabled="!isConnected">断开</el-button>
        <el-button type="success" @click="onConnect" :disabled="isConnected">连接</el-button>
      </span>
    </template>
  </el-dialog>
</template>
